 ...
 * @author Asus Gk
 */
public class Laptop extends Servis{
    
    public Laptop (long no_servis, String nama, String no_hp, String alamat, String nama_perangkat, String merk_perangkat, String keluhan){
    ...
    public void show (String estimasi, int harga, String promo){
        System.out.println("SERVIS Ke-" + 3);
        System.out.println("NO Servis               : "+getNo_servis());
        System.out.println("Nama Client             : "+getNama());
        System.out.println("NO HP                   : "+getNo_hp());
        System.out.println("Alamat                  : "+getAlamat());
        ...
        System.out.println("Promo Special           : "+promo);
    }
